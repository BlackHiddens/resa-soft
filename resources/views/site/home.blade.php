...
<main>
    ...
    {{-- ══════════════════════════════════════════════════════════
         RÉASSURANCE — bande garanties
    ══════════════════════════════════════════════════════════ --}}
    <div class="guarantee-strip" data-aos="fade-up">
        <div class="container">
            <div class="row g-3 row-cols-2 row-cols-md-4 justify-content-center text-center">
                ...
                <div class="col">
                    <div class="guarantee-strip__item">
                        <i class="bi bi-people-fill guarantee-strip__icon"></i>
                        <p class="guarantee-strip__label">{{ __('home.guarantee.groupe') }}</p>
                    </div>
                </div>
                <div class="col">
                    <div class="guarantee-strip__item">
                ...
                <div class="col">
                    <div class="guarantee-strip__item">
                        <i class="bi bi-chat-dots-fill guarantee-strip__icon"></i>
                        <p class="guarantee-strip__label">{{ __('home.guarantee.reponse') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="galerie" class="gallery-section">
        <div class="container">
            ...
            <div class="d-flex gap-3 flex-wrap justify-content-center mt-5" data-aos="fade-up">
                <a class="btn btn-primary btn-lg px-5" href="#contact">
                    {{ __('home.gallery.reserve_cta') }}
                </a>
